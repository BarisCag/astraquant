...
pub enum OperationalCommand {
    PauseVenue { venue_id: u8 },
    ResumeVenue { venue_id: u8 },
    FreezeSettlementEngine,
    InjectRecoveryLiquidity { symbol: String, size: u64, price: u64 },
    EmergencyMarginIncrease { multiplier_ppm: u64 },
    RouteOverride { original_venue: u8, target_venue: u8 },
    ForcedLiquidationHalt,
    ScenarioInterruption,
    ReplayCheckpointRestore { sequence: u64, integrity_hash: [u8; 32] },
}
