...
pub struct MarketMakerWithdrawalScenario {
    pub seed: u64,
    pub severity: ScenarioSeverity,
    pub activation_windows: Vec<(u64, u64)>,
}

impl ScenarioDefinition for MarketMakerWithdrawalScenario {
        ...
        for (start, end) in &self.activation_windows {
            if current_sequence == *start {
                ...
                events.push(AstraEvent {
                    ...
                    payload: serialize_canonical(&"MarketMakerWithdrawal").unwrap(),
