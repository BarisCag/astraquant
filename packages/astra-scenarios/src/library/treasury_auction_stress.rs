...
pub struct TreasuryAuctionStressScenario {
    pub seed: u64,
    pub severity: ScenarioSeverity,
    pub activation_windows: Vec<(u64, u64)>,
}

impl ScenarioDefinition for TreasuryAuctionStressScenario {
    fn scenario_id(&self) -> &'static str { "treasury_auction_stress" }
