use astra_benchmarks::certification::{HashParityCertificate, ReplayParityProof, ReplayLineageTree};
...
fn test_hash_parity_determinism() {
    ...
    let proof1 = ReplayParityProof { lineage_tree: tree1 };
    let proof2 = ReplayParityProof { lineage_tree: tree2 };
